...
public class UserController extends CommonUserHandler {
	...
	/**
	 * @Title: getShakeRecord @Description: 摇一摇记录接口 @param @param
	 *         request @param @return 设定文件 @return Map<String,Object>
	 *         返回类型 @throws
	 */
	...
	/**
	 * @Title: prePaymentForAlipay @Description: 微信里面使用支付宝支付预处理 @param @param
	 *         request @param @param paymentSerialNum 支付单号 @param @return
	...
	/**
	 * @Title: getPaymentResult @Description: 微信里面使用支付宝预处理，定时取支付结果 @param @param
	 *         model @param @param request @param @param response @param @param
	 *         paymentSerialNum @param @return 设定文件 @return Map<String,Object>
	 *         返回类型 @throws
	 */
	...
	/**
	 * @Title: verifyCode @Description: 验证码发送类 @param @param phone
	 *         目标手机 @param @param request @param @return 设定文件 @return Boolean
	 *         返回类型 @throws
	 */
	...
	/**
	 * @Title: verifyCode @Description: 老板助手验证码发送类 @param @param phone
	 *         目标手机 @param @param request @param @return 设定文件 @return Boolean
	 *         返回类型 @throws
	 */
	...
	/**
	 * @Title: checkVerifyCode @Description: 检验用户输入的验证码正确性 @param @param
	 *         vip @param @param request @param @return 设定文件 @return Boolean
	 *         返回类型 @throws
	 */
	...
	/**
	 * @Title: checkNapaStorePhone @Description:
	 *         老板助手登陆，验证用户输入的登陆手机号是否已非配到对应的老板 @param @param phone @param @param
	...
	/**
	 * @Title: checkNapaStorePhone @Description:
	 *         司机登陆，验证用户输入的登陆手机号是否已非配到对应的司机 @param @param phone @param @param
	 *         request @param @return 设定文件 @return Boolean 返回类型 @throws
	 */
	...
	/**
	 * @Title: choujiang @Description:
	 *         轮盘抽奖类，暂时废弃，改用下面的lotteryConfig @param @param
	 *         request @param @return 设定文件 @return Map<String,Object>
	 *         返回类型 @throws
	 */
	...
	/**
	 * @Title: home @Description: 取得微商城首页的banner和产品数据 @param @param
	 *         request @param @return 设定文件 @return Map<String,Object>
	 *         返回类型 @throws
	 */
	@RequestMapping("/home")
	...
	/**
	 * @Title: getAllProduct @Description: 根据筛选条件取得全部商品列表 @param @param
	 *         request @param @param categoryId 用户所选分类id @param @param
	 *         isSaleDesc 是否按照销量倒叙 @param @param isPriceDesc
	 *         是否按照价格倒叙 @param @return 设定文件 @return Map<String,Object>
	 *         返回类型 @throws
	 */
	@RequestMapping("/getAllProduct")
	public @ResponseBody Map<String, Object> getAllProduct(HttpServletRequest request, Integer categoryId,
			Boolean isSaleDesc, Boolean isPriceDesc, String keyword, Integer naviId) {
		Map<String, Object> map = new TreeMap<String, Object>();
	...
	/**
	 * @Title: getOrderList @Description: 对接洪石订单，取得配送中或者结单的订单 @param @param
	 *         request @param @param isEnd 是否结单 @param @return 设定文件 @return
	...
	/**
	 * @Title: getAddrById @Description: 根据地址id取得对应的地址信息 @param @param
	 *         request @param @param addrId 地址id @param @return 设定文件 @return
	 *         DeliverAddr 返回类型 @throws
	 */
	...
	/**
	 * @Title: getStoreAddr @Description:
	 *         取得当前所选加盟店对应的地理位置信息，用于地图api的调用 @param @param request @param @param
	 *         storeId @param @return 设定文件 @return NapaStore 返回类型 @throws
	 */
	...
	/**
	 * @Title: getCoupon @Description: 根据用户id取得当前用户可使用的优惠券列表 @param @param
	 *         request @param @return 设定文件 @return Map<String,Object>
	 *         返回类型 @throws
	 */
	...
	/**
	 * 新绑定会员赠送优惠券数据 @param @param request @param @return 设定文件 @return
	 * Map<String,Object> 返回类型 @throws
	 */
	...
	public @ResponseBody Map<String, Object> isVoucherLimit(HttpServletRequest request) {
		...
		if (bindingRewards != null && bindingRewards.size() >= 1) {
			List<HongShiCoupon> coupon = hongShiMapper
					.getHongShiCouponByGoodsCode(bindingRewards.get(0).getVoucherCode());
			if (coupon.size() < bindingRewards.get(0).getAmount() || coupon.size() == 0
					|| bindingRewards.get(0).getAmount() == 0) {
				map.put("result", false);
				return map;
			}
		}
	...
	public @ResponseBody Map<String, Object> Commentary(HttpServletRequest request) {
		...
		if (evaluationGift != null && evaluationGift.size() >= 1) {
			List<HongShiCoupon> coupon = hongShiMapper
					.getHongShiCouponByGoodsCode(evaluationGift.get(0).getVoucherCode());
	...
	/**
	 * @Title: order @Description: 提交订单页面的数据处理 @param @param
	 *         request @param @param cart 已选的购物车id集合 @param @return 设定文件 @return
	 *         Map<String,Object> 返回类型 @throws
	 */
	...
	public @ResponseBody Map<String, Object> order(HttpServletRequest request, @RequestBody List<CartDto> cart) {
		...
		for (ShippingFullCut shippingFullCut : shippingFullCuts) {
			String tmp = "";
			tmp = count + ". " + shippingFullCut.getsLimit() + "-" + shippingFullCut.getuLimit() + "公里," + "满"
					+ shippingFullCut.getCondition() + "元免运费";
			count++;
			salesInfo.add(tmp);
		}
	...
	/**
	 * @Title: payment @Description: 支付页面的数据接口，返回支付方式，订单信息 @param @param
	 *         request @param @param paymentSerialNum 支付单号 @param @return
	 *         设定文件 @return Map<String,Object> 返回类型 @throws
	 */
	...
	/**
	 * @Title: unpayOrderList @Description: 根据用户id选择待支付订单列表信息 @param @param
	 *         request @param @return 设定文件 @return Map<String,Object>
	 *         返回类型 @throws
	 */
	...
	/**
	 * @Title: wxConfig @Description: 调用微信jssdk的工具接口，取得必要的参数信息 @param @param
	 *         model @param @param request @param @param response @param @param
	 *         url @param @return 设定文件 @return Map<String,String> 返回类型 @throws
	 */
	@RequestMapping(value = "/wxConfig")
	@ResponseBody
	public Map<String, String> wxConfig(ModelMap model, HttpServletRequest request, HttpServletResponse response,
			String url) {
		url = url.replaceAll("\\+", "&");
	...
	/**
	 * @Title: distCenter @Description: 根据用户id取得对应的分销中心的数据接口 @param @param
	 *         request @param @return 设定文件 @return Map<String,Object>
	 *         返回类型 @throws
	 */
	...
	/**
	 * @Title: distUser @Description: 根据用户id取得对应的下级用户列表 @param @param
	 *         request @param @param userId 指定的用户id @param @return 设定文件 @return
	 *         Map<String,Object> 返回类型 @throws
	 */
	...
	/**
	 * @Title: distOrder @Description: 根据用户id取得其下级，下下级的订单列表 @param @param
	 *         request @param @return 设定文件 @return Map<String,Object>
	 *         返回类型 @throws
	 */
	...
	/**
	 * @Title: invitation @Description: 根据用户id取得对应的下级用户列表 ，已废弃，改为上述的
	 *         distUser @param @param request @param @param
	 *         userId @param @return 设定文件 @return List<UserInvitedLink>
	 *         返回类型 @throws
	 */
	...
	/**
	 * @Title: invitationOrder @Description: 根据用户id取得对应的下级订单列表
	 *         ，已废弃，改为上述的distOrder @param @param request @param @param
	 *         serialNum @param @return 设定文件 @return List<Order> 返回类型 @throws
	 */
	...
	/**
	 * @Title: editAddr @Description: 编辑或者新增地址页面数据接口 @param @param
	 *         request @param @param deliverAddrId
	 *         如果是编辑，就传对应的地址id，得到源数据 @param @return 设定文件 @return
	 *         Map<String,Object> 返回类型 @throws
	 */
	...
	/**
	 * @Title: addrList @Description: 获取用户的地址列表数据 @param @param
	 *         request @param @param productId @param @return 设定文件 @return
	 *         List<DeliverAddr> 返回类型 @throws
	 */
	...
	/**
	 * @Title: cart @Description: 根据userId和storeId获取当期用户的购物车数据 @param @param
	 *         request @param @param storeId
	 *         所选加盟店id，用于判断购物车商品是否被当前加盟店支持 @param @return 设定文件 @return
	 *         List<CartDto> 返回类型 @throws
	 */
	@RequestMapping("/cart")
	...
	/**
	 * @Title: productDetail @Description: 产品详情单页的数据接口 @param @param
	 *         request @param @param productId 产品id @param @return 设定文件 @return
	 *         ProductDto 返回类型 @throws
	 */
	...
	/**
	 * @Title: @Description: 获取微信appid配置 @param @param request @param @return
	...
	/**
	 * @Title: shakeHandler @Description: 摇一摇数据处理 @param @param
	 *         request @param @return 设定文件 @return boolean 返回类型 @throws
	 */
	...
	/**
	 * @Title: getLotteryConfig @Description:
	 *         积分抽奖页面数据接口，获得积分抽奖配置等信息 @param @param request @param @return
	 *         设定文件 @return Map<String,Object> 返回类型 @throws
	 */
	...
	/**
	 * @Title: recharge @Description: 充值页面数据接口 @param @param
	 *         request @param @return 设定文件 @return Map<String,Object>
	 *         返回类型 @throws
	 */
	...
	public @ResponseBody Map<String, Object> recharge(HttpServletRequest request) {
		...
		for (RechargeConfig config : configs) {
			if (config.getStartTime() != null && config.getEndTime() != null && new Date().after(config.getStartTime())
					&& new Date().before(config.getEndTime())) {
				map.put("inTime", true);
				config.setInTime(true);
				RechargeRewardsRecord record = rechargeRewardsRecordMapper.selectByConfigIdAndUserId(config.getId(),
						userId);
				if (record == null || (config.getLimit() != null && config.getLimit() > record.getCount())) {
					...
					if (!StringUtils.isEmpty(config.getVoucherCode())) {
						...
						if (coupon != null && coupon.size() > 0 && config.getAmount() != null
								&& config.getAmount() > 0) {
							HongShiCoupon name = hongShiMapper.getCouponName(coupon.get(0).getGoodsCode());
							// coupon.get(0).getPayQuota().setScale(2,
							// BigDecimal.ROUND_DOWN)+"元现金优惠券"
					...
					if (!StringUtils.isEmpty(config.getVoucherCodeSecond())) {
						List<HongShiCoupon> coupon2 = hongShiMapper
								.getHongShiCouponByGoodsCode(config.getVoucherCodeSecond());
						if (coupon2 != null && coupon2.size() > 0 && config.getAmountSecond() != null
								&& config.getAmountSecond() > 0) {
							HongShiCoupon name = hongShiMapper.getCouponName(coupon2.get(0).getGoodsCode());
							// coupon2.get(0).getPayQuota().setScale(2,
							// BigDecimal.ROUND_DOWN) + "元现金优惠券"
					...
					if (!StringUtils.isEmpty(config.getVoucherCodeSecond())) {
						List<HongShiCoupon> coupon3 = hongShiMapper
								.getHongShiCouponByGoodsCode(config.getVoucherCodeThird());
						if (coupon3 != null && coupon3.size() > 0 && config.getAmountThird() != null
								&& config.getAmountThird() > 0) {
							HongShiCoupon name = hongShiMapper.getCouponName(coupon3.get(0).getGoodsCode());
							// coupon3.get(0).getPayQuota().setScale(2,
							// BigDecimal.ROUND_DOWN) + "元现金优惠券"
					...
					if (extra != null && extra.size() > 0) {
						extraData.put(String.valueOf(config.getMoney().multiply(new BigDecimal(100)).intValue()),
								extra);
					}
				}
			} else {
		...
		OauthLogin login = userService.getOauthLoginInfoByUserId(userId);
		if (login != null) {
			List<HongShiVip> ret = hongShiVipService.getVipInfo(login.getOauthId());// openid
																					// 去拿信息
	...
	/**
	 * @Title: getProvince @Description: 获取省份数据 @param @param
	 *         request @param @return 设定文件 @return Map<String,Object>
	 *         返回类型 @throws
	 */
	...
	/**
	 * @Title: getShippingFee @Description: 根据距离获取两地址的运费 @param @param
	 *         request @param @param distance @param @return 设定文件 @return
	 *         Map<String,Object> 返回类型 @throws
	 */
	...
	/**
	 * @Title: getCities @Description: 根据省份id获取对应的城市列表 @param @param
	 *         request @param @param provinceId 省份id @param @return 设定文件 @return
	 *         Map<String,Object> 返回类型 @throws
	 */
	...
	/**
	 * @Title: getCities @Description: 根据省份名称获取对应城市列表 @param @param
	 *         request @param @param stateId 省份名称 @param @return 设定文件 @return
	 *         Map<String,Object> 返回类型 @throws
	 */
	...
	/**
	 * @Title: getRegions @Description:根据城市id获取对应区列表 @param @param
	 *         request @param @param cityId 城市id @param @return 设定文件 @return
	 *         Map<String,Object> 返回类型 @throws
	 */
	...
	/**
	 * @Title: getRegionsByStr @Description: 根据城市名称获取对应的区列表 @param @param
	 *         request @param @param cityId @param @return 设定文件 @return
	 *         Map<String,Object> 返回类型 @throws
	 */
	...
	/**
	 * @Title: getUserInfo @Description: 获取用户的基本信息 @param @param
	...
	public Map<String, Object> getUserInfo(HttpServletRequest request, HttpServletResponse response) {
		...
		OauthLogin tt = userService.getOauthLoginInfoByUserId(userId);
		if (tt != null) {
			List<HongShiVip> ret = hongShiVipService.getVipInfo(tt.getOauthId());// openid
																					// 去拿信息
			if (ret != null && ret.size() > 0) {
	...
	/**
	 * @Title: tokenLogin @Description: 用token来长期保存登陆状态 @param @param
	 *         token @param @param request @param @return 设定文件 @return
	 *         Map<String,Object> 返回类型 @throws
	 */
	...
	/**
	 * @Title: ipAddr @Description: 获取当前请求的ip @param @param
	 *         request @param @param cityId @param @return 设定文件 @return
	 *         Map<String,Object> 返回类型 @throws
	 */
	...
	/**
	 * @Title: isSubscribe @Description:判断当前用户是否关注公众号 @param @param
	 *         request @param @return 设定文件 @return Map<String,Object>
	 *         返回类型 @throws
	 */
	...
	/**
	 * @Title: getSerialNum @Description: 根据用户id获取其对应的用户序列号 @param @param
	 *         request @param @return 设定文件 @return Map<String,Object>
	 *         返回类型 @throws
	 */
	...
	/**
	 * @Title: isWC @Description: 根据请求头判断当前请求是否属于微信请求 @param @param
	 *         model @param @param request @param @param response @param @return
	 *         设定文件 @return Map<String,Object> 返回类型 @throws
	 */
	...
	/**
	 * @Title: fastPaymentScan @Description: 方法已废弃 @param @param
	 *         model @param @param request @param @param response @param @param
	 *         url @param @return 设定文件 @return Map<String,String> 返回类型 @throws
	 */
	@RequestMapping(value = "/fastPaymentScan")
	@ResponseBody
	public Map<String, String> fastPaymentScan(ModelMap model, HttpServletRequest request, HttpServletResponse response,
			String url) {
	...
	/**
	 * @Title: wCVerify @Description: 测试方法，请忽略 @param @param model @param @param
	 *         request @param @param response @param @param
	 *         echostr @param @return 设定文件 @return String 返回类型 @throws
	 */
	@RequestMapping(value = "/wCVerify")
	@ResponseBody
	public String wCVerify(ModelMap model, HttpServletRequest request, HttpServletResponse response, String echostr) {
		return echostr;
	}

	/**
	 * @Title: testWXMessage @Description: 测试发送微信短信 @param @param
	 *         model @param @param request @param @param response @param @return
	 *         设定文件 @return String 返回类型 @throws
	 */
	@RequestMapping(value = "/testWXMessage")
	@ResponseBody
	public String testWXMessage(ModelMap model, HttpServletRequest request, HttpServletResponse response) {
		duobaoService.sendWXMessageSuccess(105, 5, "14782464907416592");
		return "";
	}

	/**
	 * @Title: bossCenter @Description: 老板助手数据接口 @param @param
	 *         request @param @param phone @param @param hsCode @param @return
	 *         设定文件 @return Map<String,Object> 返回类型 @throws
	 */
	...
	public @ResponseBody Map<String, Object> assistant(HttpServletRequest request, String QueryName, String phone,
			String hsCode) {
	...
	public @ResponseBody HongShiCommonResult zengsong(HttpServletRequest request, String oauthId, Integer point,
			String tag) {
		...
		for (int i = 0; i < evaluationGifts.get(0).getAmount(); i++) {
			List<HongShiCoupon> coupon = hongShiMapper
					.getHongShiCouponByGoodsCode(evaluationGifts.get(0).getVoucherCode());
			if (coupon != null && !coupon.isEmpty()) {
				if (coupon != null && coupon.size() > 0) {
					int a = hongShiMapper.saleVoucher(evaluationGifts.get(0).getVoucherCode(),
							coupon.get(0).getVouchersCode(), oauthLogin.getOauthId(), "评价赠送礼券");
					if (a > 0) {
		...
		// 评论送金额
		HongShiRecharge dd = new HongShiRecharge().setcWeiXinCode(oauthLogin.getOauthId()).setcWeiXinOrderCode(null)
				.setnAddMoney(evaluationGifts.get(0).getMoney());
	...
	public @ResponseBody HongShiCommonResult SigningGift(HttpServletRequest request, String oauthId, Integer point,
			String tag) {
		HttpSession session = request.getSession();
		Integer userId = (Integer) session.getAttribute(GlobalSessionConstant.USER_ID);
		OauthLogin oauthLogin = userService.getOauthLoginInfoByUserId(userId);
				...
				for (int i = 0; i < integralinGifts.size(); i++) {
					if (accumulation == integralinGifts.get(i).getDay()) {
						...
						for (int j = 0; j < amount; j++) {
							List<HongShiCoupon> coupon = hongShiMapper
									.getHongShiCouponByGoodsCode(integralinGifts.get(i).getVoucherCode());
							if (coupon != null && !coupon.isEmpty()) {
								if (coupon != null && coupon.size() > 0) {

									int s = hongShiMapper.saleVoucher(integralinGifts.get(i).getVoucherCode(),
											coupon.get(i).getVouchersCode(), oauthLogin.getOauthId(), "签到赠送礼券");
									if (s > 0) {
										System.out.println("发送成功");
									} else {
										System.out.println("发送失败");
						...
						HongShiRecharge dd = new HongShiRecharge().setcWeiXinCode(oauthLogin.getOauthId())
								.setcWeiXinOrderCode(null).setnAddMoney(integralinGifts.get(i).getMoney());
						hongShiVipService.hongShiRecharge(dd);
					}
				}
			}
						...
						for (int j = 0; j < amount; j++) {
							...
							if (coupon != null && !coupon.isEmpty()) {
								if (coupon != null && coupon.size() > 0) {
									...
									int s = hongShiMapper.saleVoucher(oauthLogin.getOauthId(),
											coupon.get(i).getVouchersCode(), integralinGifts.get(i).getVoucherCode(),
											"签到赠送礼券");
									if (s > 0) {
										System.out.println("发送成功");
									} else {
	...
	/**
	 * 插入记录到发起砍价表并把发起人砍价 记录插入到砍价记录表
	 */
	@RequestMapping("/LaunchBargain")
	public @ResponseBody Map<String, Object> LaunchBargain(HttpServletRequest request, String name,
			BigDecimal hsGoodsPrice, String codes, Integer pid, String productName) {
		Map<String, Object> map = new TreeMap<String, Object>();
		HttpSession session = request.getSession();
		Integer userId = (Integer) session.getAttribute(GlobalSessionConstant.USER_ID);
	...
	public @ResponseBody Map<String, Object> insertBargainLog(HttpServletRequest request, String codes,
			String productName, Integer valueId) {
		Map<String, Object> map = new TreeMap<String, Object>();
		HttpSession session = request.getSession();
		Integer userId = (Integer) session.getAttribute(GlobalSessionConstant.USER_ID);
		OauthLogin oauth = userService.getOauthLoginInfoByUserId(userId);
	...
	public @ResponseBody Map<String, Object> receiveCoupon(HttpServletRequest request, String voucher, String name) {
		...
		if (log != null && log.size() > 0) {
			...
			if (vip != null && !vip.equals("")) {
				if (coupon != null || coupon.size() > 0) {
					hongShiMapper.saleVoucher(voucher, coupon.get(0).getVouchersCode(), oauthLogin.getOauthId(),
							"会员领礼券");
		...
		if (!d1.equals(d2)) {
			if (vip != null) {
				if (coupon != null || coupon.size() > 0) {
					hongShiMapper.saleVoucher(oauthLogin.getOauthId(), coupon.get(0).getVouchersCode(), voucher,
							"会员领礼券");
					LinkCouponLogs linkCouponLogs = new LinkCouponLogs();
					linkCouponLogs.setName(name);
					linkCouponLogs.setOauthId(oauthLogin.getOauthId());
	...
	public @ResponseBody Map<String, Object> DeliveryCenter(HttpServletRequest request, String phone, String hsCode,
			Integer type) {
