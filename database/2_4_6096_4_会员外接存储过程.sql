...
Create Procedure [dbo].[CreateOrder]
	   ...
	   @客户编号    varchar(100)=''   --记录客户微信Open_Id
As
Begin
  Declare @LogID int,@ParaInfo varchar(128)
...
Begin
  ...
  If @OrderCode<>''
    Begin--查询指定单号的订单,不受日期限制
      ...
      Select  ID, 单号, 部门编号, 日期, 往来编号, 单位名称, 联系方式, 交货日期, 取货时间, 结单, 订金
	  , 金额合计, 应收金额, 欠款, 生产单位, 制单人, 审核人, 记帐人, 建立日期, 是否废止, 备注, 礼券
  ...
  Else If @authcode<>''
    Begin--查询指定会员的下级会员分销订单
      ...
      Select a.ID, 单号, 部门编号, 日期, 往来编号, 单位名称, 联系方式, 交货日期, 取货时间, 结单, 订金
	  , 金额合计, 应收金额, 欠款, 生产单位, 制单人, 审核人, 记帐人, 建立日期, 是否废止, 备注, 礼券
	  , 让利, 刷卡金额, 送货地址, 折扣率, 优惠合计, 当前余额, 当前积分, 打印标记,'', 加工状态
	  , 刷卡日期, 礼券日期,商户订单号, 取货部门, 配送人, 订收现金, 订收礼券, 订收刷卡, 优惠状态,销售类别, 订单类别,b.[Level] As Hierarchy From orders As A
  ...
  Else
    Begin--没有结定限制条件
      ...
      Select Top 0 ID, 单号, 部门编号, 日期, 往来编号, 单位名称, 联系方式, 交货日期, 取货时间, 结单, 订金
	  , 金额合计, 应收金额, 欠款, 生产单位, 制单人, 审核人, 记帐人, 建立日期, 是否废止, 备注, 礼券
	  , 让利, 刷卡金额, 送货地址, 折扣率, 优惠合计, 当前余额, 当前积分, 打印标记,'', 加工状态
	  , 刷卡日期, 礼券日期,商户订单号, 取货部门, 配送人, 订收现金, 订收礼券, 订收刷卡, 优惠状态,销售类别, 订单类别
      ,0 As Hierarchy From orders
...
Begin
  ...
  Create Table #tmp_WSC_GetVipInfo
        ...
        ,Assessor varchar(20),Bookkeeper varchar(20),memo varchar(200)
...
Go
Create Procedure [dbo].[WSC_CreateOrder]
	   ...
	   @WXOpenID    varchar(100)=''    --记录客户微信Open_Id
As
Begin
  Declare @LogID int,@ParaInfo varchar(128)
...
Go
Create Procedure [dbo].[WSC_GetOrdersList]
       @StartDate  varchar(10)='1900-01-01',--日期范围:开始日期
       @EndDate    varchar(10)=''          ,--日期范围:结束日期
       @OrderCode  varchar(20)=''          ,--订单号
       @VipCode    varchar(50)=''          ,--会员外键
...
Begin
  ...
  Create Table #tmp_WSC_GetOrdersList
        ...
        ,CreateTime datetime,IsVoid bit,memo varchar(200)
        ...
        ,IsPrinted bit,Reserved1 varchar(100),BuildState int,DepositTime varchar(10),DepositTime2 varchar(10)
...
Go
Create procedure 
   Get_WordVal(@bookname varchar(50))
as
begin
  
   declare @Value Varchar(1), @WordVal Varchar(1)
